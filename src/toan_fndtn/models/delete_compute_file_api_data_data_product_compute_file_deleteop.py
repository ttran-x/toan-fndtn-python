...
class DeleteComputeFileAPIDataDataProductComputeFileDeleteRequestTypedDict(TypedDict):
    identifier: str
    x_org: str
    x_org_override: NotRequired[Nullable[str]]


class DeleteComputeFileAPIDataDataProductComputeFileDeleteRequest(BaseModel):
