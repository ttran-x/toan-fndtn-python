...
class GetOrchestratorWorkflowGraphAPIDataOrchestratorWorkflowGraphGetRequestTypedDict(
    TypedDict
):
    identifier: str
    x_org: str
...
class GetOrchestratorWorkflowGraphAPIDataOrchestratorWorkflowGraphGetRequest(BaseModel):
