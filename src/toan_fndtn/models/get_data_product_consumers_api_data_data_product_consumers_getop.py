...
class GetDataProductConsumersAPIDataDataProductConsumersGetRequestTypedDict(TypedDict):
    identifier: str
    x_org: str
    x_org_override: NotRequired[Nullable[str]]


class GetDataProductConsumersAPIDataDataProductConsumersGetRequest(BaseModel):
