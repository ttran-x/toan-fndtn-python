...
class GetLineageDataProductAPIDataDataProductLineageGetRequestTypedDict(TypedDict):
    identifier: str
    x_org: str
    show_jobs: NotRequired[bool]
    depth: NotRequired[int]
    x_org_override: NotRequired[Nullable[str]]


class GetLineageDataProductAPIDataDataProductLineageGetRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["show_jobs", "depth", "x-org-override"]
