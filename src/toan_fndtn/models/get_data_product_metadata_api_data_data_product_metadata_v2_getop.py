...
class GetDataProductMetadataAPIDataDataProductMetadataV2GetRequestTypedDict(TypedDict):
    identifier: str
    x_org: str
    x_org_override: NotRequired[Nullable[str]]


class GetDataProductMetadataAPIDataDataProductMetadataV2GetRequest(BaseModel):
