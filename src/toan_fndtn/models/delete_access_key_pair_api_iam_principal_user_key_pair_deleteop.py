...
class DeleteAccessKeyPairAPIIamPrincipalUserKeyPairDeleteRequestTypedDict(TypedDict):
    identifier: str
    access_key_id: str
    x_org: str
...
class DeleteAccessKeyPairAPIIamPrincipalUserKeyPairDeleteRequest(BaseModel):
