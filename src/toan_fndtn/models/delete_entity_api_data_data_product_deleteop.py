...
class DeleteEntityAPIDataDataProductDeleteRequestTypedDict(TypedDict):
    identifier: str
    x_org: str
...
class DeleteEntityAPIDataDataProductDeleteRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["force", "x-org-override"]
