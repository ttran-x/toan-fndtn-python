...
class DeleteApplicationLinkAPIDataLinkDataProductApplicationDeleteRequestTypedDict(
    TypedDict
):
    identifier: str
...
class DeleteApplicationLinkAPIDataLinkDataProductApplicationDeleteRequest(BaseModel):
    identifier: Annotated[
        str, FieldMetadata(query=QueryParamMetadata(style="form", explode=True))
    ]

    child_identifier: Annotated[
        str, FieldMetadata(query=QueryParamMetadata(style="form", explode=True))
    ]
