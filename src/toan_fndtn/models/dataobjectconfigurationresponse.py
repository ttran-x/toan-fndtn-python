...
DataObjectConfigurationResponseConfigurationTypedDict = TypeAliasType(
...
DataObjectConfigurationResponseConfiguration = Annotated[
    Union[
...
class DataObjectConfigurationResponseTypedDict(TypedDict):
    r"""Data object configuration response."""

    configuration: NotRequired[
        Nullable[DataObjectConfigurationResponseConfigurationTypedDict]
    ]


class DataObjectConfigurationResponse(BaseModel):
    r"""Data object configuration response."""

    configuration: OptionalNullable[DataObjectConfigurationResponseConfiguration] = (
        UNSET
    )
