...
class GetValidationResultsAPIDataDataProductQualityValidationsGetRequestTypedDict(
    TypedDict
):
    identifier: str
    x_org: str
...
class GetValidationResultsAPIDataDataProductQualityValidationsGetRequest(BaseModel):
