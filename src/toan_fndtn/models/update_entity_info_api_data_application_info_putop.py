...
class UpdateEntityInfoAPIDataApplicationInfoPutRequestTypedDict(TypedDict):
    identifier: str
    x_org: str
    entity_info: EntityInfoTypedDict
    x_org_override: NotRequired[Nullable[str]]


class UpdateEntityInfoAPIDataApplicationInfoPutRequest(BaseModel):
