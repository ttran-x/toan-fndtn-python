...
class DeleteSensitivityByNameAPIDataSensitivityNameDeleteRequestTypedDict(TypedDict):
    name: str
    x_org: str
    x_org_override: NotRequired[Nullable[str]]


class DeleteSensitivityByNameAPIDataSensitivityNameDeleteRequest(BaseModel):
    name: Annotated[
