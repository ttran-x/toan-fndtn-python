...
class GetClassificationByNameAPIDataClassificationNameGetRequestTypedDict(TypedDict):
    name: str
    x_org: str
    x_org_override: NotRequired[Nullable[str]]


class GetClassificationByNameAPIDataClassificationNameGetRequest(BaseModel):
    name: Annotated[
