...
class GetProfilingResultsAPIDataDataProductQualityProfilingGetRequestTypedDict(
    TypedDict
):
    identifier: str
    x_org: str
...
class GetProfilingResultsAPIDataDataProductQualityProfilingGetRequest(BaseModel):
