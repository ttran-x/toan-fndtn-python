...
class GetComputeLineageAPIDataDataProductComputeLineageGetRequestTypedDict(TypedDict):
    identifier: str
    x_org: str
    x_org_override: NotRequired[Nullable[str]]


class GetComputeLineageAPIDataDataProductComputeLineageGetRequest(BaseModel):
