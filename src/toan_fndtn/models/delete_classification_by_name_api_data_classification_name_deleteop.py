...
class DeleteClassificationByNameAPIDataClassificationNameDeleteRequestTypedDict(
    TypedDict
):
    name: str
    x_org: str
...
class DeleteClassificationByNameAPIDataClassificationNameDeleteRequest(BaseModel):
    name: Annotated[
