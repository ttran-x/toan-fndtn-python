...
class DeleteOrganizationAPIIamOrganizationDeleteRequestTypedDict(TypedDict):
    identifier: str
    x_org: str
...
class DeleteOrganizationAPIIamOrganizationDeleteRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["full", "x-org-override"]
