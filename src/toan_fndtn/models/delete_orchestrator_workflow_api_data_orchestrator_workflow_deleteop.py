...
class DeleteOrchestratorWorkflowAPIDataOrchestratorWorkflowDeleteRequestTypedDict(
    TypedDict
):
    identifier: str
    x_org: str
...
class DeleteOrchestratorWorkflowAPIDataOrchestratorWorkflowDeleteRequest(BaseModel):
