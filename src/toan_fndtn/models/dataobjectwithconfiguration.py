...
DataObjectWithConfigurationConfigurationTypedDict = TypeAliasType(
...
DataObjectWithConfigurationConfiguration = Annotated[
    Union[
...
class DataObjectWithConfigurationTypedDict(TypedDict):
    r"""Data object with configuration."""
    ...
    configuration: NotRequired[
        Nullable[DataObjectWithConfigurationConfigurationTypedDict]
    ]


class DataObjectWithConfiguration(BaseModel):
    r"""Data object with configuration."""
    ...
    configuration: OptionalNullable[DataObjectWithConfigurationConfiguration] = UNSET

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = ["is_system", "owner", "configuration"]
        nullable_fields = ["owner", "configuration"]
        null_default_fields = []
