...
class DeleteCustomExpectationAPIDataDataProductQualityExpectationCustomDeleteRequestTypedDict(
    TypedDict
):
    identifier: str
...
class DeleteCustomExpectationAPIDataDataProductQualityExpectationCustomDeleteRequest(
    BaseModel
):
