...
class GetUsersAPIIamPrincipalUserListGetRequestTypedDict(TypedDict):
    x_org: str
...
class GetUsersAPIIamPrincipalUserListGetRequest(BaseModel):
    x_org: Annotated[
        str,
    ...
    def serialize_model(self, handler):
        optional_fields = ["search", "system", "x-org-override"]
        nullable_fields = ["search", "system", "x-org-override"]
        null_default_fields = []
