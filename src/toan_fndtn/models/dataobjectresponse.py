...
DataObjectResponseConfigurationTypedDict = TypeAliasType(
...
DataObjectResponseConfiguration = Annotated[
    Union[
...
class DataObjectResponseTypedDict(TypedDict):
    r"""Data object response."""
    ...
    configuration: NotRequired[Nullable[DataObjectResponseConfigurationTypedDict]]
...
class DataObjectResponse(BaseModel):
    ...
    configuration: OptionalNullable[DataObjectResponseConfiguration] = UNSET

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = ["entity_info", "compute_identifier", "configuration"]
        nullable_fields = ["entity_info", "compute_identifier", "configuration"]
        null_default_fields = []
