...
class GetExpectationResultsAPIDataDataProductQualityExpectationGetRequestTypedDict(
    TypedDict
):
    identifier: str
    x_org: str
...
class GetExpectationResultsAPIDataDataProductQualityExpectationGetRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["last_only", "x-org-override"]
