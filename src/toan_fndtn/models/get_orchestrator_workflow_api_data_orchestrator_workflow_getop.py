...
class GetOrchestratorWorkflowAPIDataOrchestratorWorkflowGetRequestTypedDict(TypedDict):
    identifier: str
    x_org: str
    x_org_override: NotRequired[Nullable[str]]


class GetOrchestratorWorkflowAPIDataOrchestratorWorkflowGetRequest(BaseModel):
