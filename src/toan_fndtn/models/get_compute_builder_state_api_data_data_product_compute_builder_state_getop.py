...
class GetComputeBuilderStateAPIDataDataProductComputeBuilderStateGetRequestTypedDict(
    TypedDict
):
    identifier: str
    x_org: str
...
class GetComputeBuilderStateAPIDataDataProductComputeBuilderStateGetRequest(BaseModel):
