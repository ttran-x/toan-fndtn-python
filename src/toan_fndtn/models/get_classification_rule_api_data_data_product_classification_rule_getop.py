...
class GetClassificationRuleAPIDataDataProductClassificationRuleGetRequestTypedDict(
    TypedDict
):
    identifier: str
    x_org: str
...
class GetClassificationRuleAPIDataDataProductClassificationRuleGetRequest(BaseModel):
